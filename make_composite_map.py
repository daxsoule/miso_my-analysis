...
def make_composite_map():
    ...
    caption_text = (
        ...
        "(MBARI, 2025) with 20 m depth contours. Panel (b) shows a detailed "
        "view of the ASHES vent field mapped with 1 cm LASS lidar bathymetry "
        "(MBARI, 2025) with 1 m depth contours. Panel (c) shows the "
        "International District vent field at the same scale, also mapped "
        "with 1 cm LASS lidar bathymetry (MBARI, 2025) with 1 m depth "
        "contours. Vent markers are colored by temperature classification "
        "from the 2024\u20132025 MISO deployment. Detail panels use locally "
