"""Generate Fig 5 — Modeled Eruption Response (vent temp change) for poster."""
...
def main():
    ...
    caption = (
        "Modeled vent temperature response to eruption-related perturbations "
        "using FISHES (Lewis and Lowell, 2009). Shallow and deep breaches of "
        "the upflow zone produce rapid temperature declines, while global "
        "permeability reduction and dike intrusion show more gradual responses."
    )
